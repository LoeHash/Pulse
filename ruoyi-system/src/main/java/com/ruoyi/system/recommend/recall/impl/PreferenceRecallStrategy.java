...
public class PreferenceRecallStrategy implements RecallStrategy, DynamicConfigListener<AlgoConfig> {

    private final ForumPostMapper postMapper;
    private final com.ruoyi.system.recommend.service.IRecommendExposureService exposureService;

    private static int TOP_TAG_N = 5;
    private static int TOP_BOARD_N = 3;
    private static double LAMBDA = 0.03D;
    ...
    public void onChange(AlgoConfig newConfig) {
        ...
        synchronized (this){
            TOP_TAG_N = newConfig.getPreferenceTopN();
            TOP_BOARD_N = newConfig.getPreferenceBoardTopN();
            LAMBDA = newConfig.getTimeDecay();
        }
    }
}